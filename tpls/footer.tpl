...
<div id="footer">
    ...
    <div id="dialog3" title="&copy; Theme by BMyA">
		<p>BMyA2 Theme written by:</p>
		<br />
		<p style="align:center">
			<a href="http://blancomartin.cl" target="_blank"><img src="index.php?entryPoint=getImage&imageName=bmyagris3.jpg" alt="BMyA Logo" border="0" />&nbsp;Blanco Martín & Asociados</a>
			<br /><br />We are an Independent CRM Specialist Company.
		</p>
		<p>Design based on "SpecINFO Blue" Theme.
		<br />Specially setup for SuiteCRM.
		<br />This is free software.</p>
    </div>

    <button id="admin_options">Supercharged by SuiteCRM</button>
    <button id="powered_by">&copy; Powered by SugarCRM</button>
    <button id="theme_by">&copy; Theme by BMyA</button>
